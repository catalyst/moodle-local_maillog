...
/**
 * Send scheduled mail log mails.
 */
class send_scheduled extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('task:sendscheduled', 'local_maillog');
    }
